        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'name' => 'phone-number',
                    'type' => 'text',
                    'instructions' => 'Nr telefonu wyświetlany na dolnej belce strony.',
                    'required' => 1,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
                ...
                array(
                    'key' => 'event_instance',
                    'label' => 'ID Instancji eventów',
                    'name' => 'event_instance',
                    'type' => 'text',
                    'instructions' => 'Nie wprowadzaj żadnych zmian',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
                ...
                array(
                    'key' => 'code_test_drive',
                    'label' => 'Dodatkowy kod na podstronie z podziękowaniem dla jazd testowych',
                ...
                array(
                    'key' => 'htmlCode',
                    'label' => 'Dodatkowy kod html do strony głównej',
                    'name' => 'htmlCode',
                    'type' => 'textarea',
                    'instructions' => '',
                    'required' => 0,
                ...
                array(
                    'key' => 'globalJs',
                    'label' => 'Dodatkowy kod JavaScript na przycisku pokaż numer telefonu',
                    'name' => 'globalJs',
                    'type' => 'textarea',
                    'instructions' => '',
                    'required' => 0,
                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'chat_disable_icon',
                            'label' => 'Ukryj domyślną ikonę',
                            'name' => 'chat_disable_icon',
                            'type' => 'true_false',
                            'instructions' => '',
                            'required' => 0,
                            'conditional_logic' => 0,
                ...
                array(
                    ...
                    'sub_fields' => array(
                        array(
                            ...
                            'label' => 'Kod do sekcji head (zawartość pliku manifest.json)',
                        ...
                        array(
                            ...
                            'label' => 'Kod sw (zawartośc pliku sw)',
                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'pixel_enable',
                            'label' => 'Włącz facebook pixel na każdej podstronie',
                            'name' => 'pixel_enable',
                            'type' => 'true_false',
                            'instructions' => '',
                            'required' => 0,
                ...
                array(
                    ...
                    'sub_fields' => array(
                        array(
                            'key' => 'field_noindex_setup',
                            'label' => 'Adresy przy których ma pojawić się w head noindex',
                            'name' => 'field_noindex_setup',
                            'type' => 'repeater',
                            'instructions' => '',
                            'required' => 0,
                            'conditional_logic' => 0,
                            ...
                            'sub_fields' => array(
                                array(
                                    'key' => 'field_noindex_setup_value',
                                    'label' => 'Nie indeksuj:',
                                    'name' => 'field_noindex_setup_value',
                                    'type' => 'url',
                                    'instructions' => '',
                                    'required' => 0,
                                    'conditional_logic' => 0,
