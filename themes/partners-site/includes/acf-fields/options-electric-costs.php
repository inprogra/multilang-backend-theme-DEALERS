	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				array(
					'key'               => 'form_title',
					'label'             => 'Tytuł na belce dolnej (Na stronach elektryfikacja)',
					'name'              => 'form_title',
					'type'              => 'text',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'label'             => 'Wyklucz silniki dla wersji wyposażenia',
					'name'              => 'engines_in_versions',
					'type'              => 'repeater',
					'instructions'      => 'Zaznaczone silniki nie występują dla danej wersji wyposażenia',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					...
					'label'             => 'Wartości ładowarek kalkulator',
