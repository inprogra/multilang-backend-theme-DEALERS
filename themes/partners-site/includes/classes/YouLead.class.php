...
class YouLead
{
	...
	public function getProductsShorDefaultXml()
	{
		$data = $this->getProductsShortWithKeys('default');

		return $data;
	}
	public function getProductsShortXml()
	{
		$data = $this->getProductsShortWithKeys();
