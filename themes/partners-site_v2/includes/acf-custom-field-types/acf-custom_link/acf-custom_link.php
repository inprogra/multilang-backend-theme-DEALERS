...
if ( ! class_exists( 'acf_field_custom_link' ) ) :

	class acf_field_custom_link extends acf_field {
		...
		*/
		...
		function input_admin_enqueue_scripts() {
			wp_register_style( 'acf-custom_link', get_template_directory_uri() . '/includes/acf-custom-field-types/acf-custom_link/acf-custom_link.css', false, '1.0.0' );
			wp_enqueue_style( 'acf-custom_link' );

			wp_register_script( 'acf-custom_link', get_template_directory_uri() . '/includes/acf-custom-field-types/acf-custom_link/acf-custom_link.js' );
			wp_enqueue_script( 'acf-custom_link' );
		}
		...
		*/
		...
		function render_field( $field ) {
			...
			$div = array(
				'id'    => $field['id'],
				'class' => $field['class'] . ' acf-custom-link',
			);
			...
			<div <?php acf_esc_attr_e( $div ); ?>>
				...
				<div class="acf-hidden">
					<a class="link-node" data-text-choices="<?php echo implode( ',', $field['text_choices'] ); ?>" href="<?php echo esc_url( $link['url'] ); ?>" target="<?php echo esc_attr( $link['target'] ); ?>"><?php echo esc_html( $link['title'] ); ?></a>
	...
	// initialize
	acf_register_field_type( 'acf_field_custom_link' );
