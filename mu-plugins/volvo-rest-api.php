...
function volvo_get_showrooms() {
    ...
    if (
        ...
        $blog_info->domain !== 'autobruno-gorzow.volvocars-partner.pl'
    ) {
        ...
        foreach ($showroom_posts as $showroom) {
            $showroom = [
                ...
                'name'          => ($name = get_field('name', $showroom->ID)) ? $name : $showroom->post_title,
                'showroom'      => get_post_field( 'post_name', $showroom ),
